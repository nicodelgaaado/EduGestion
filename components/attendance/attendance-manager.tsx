...
export function AttendanceManager() {
  ...
  const students = [
    { id: 'u1', name: 'Juan Pérez', attendance: 85 },
    { id: 'u5', name: 'Ana Martínez', attendance: 95 },
    { id: 'u8', name: 'Carlos Ruiz', attendance: 72 },
    { id: 'u9', name: 'Elena Gómez', attendance: 88 },
  ];
    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row gap-4 items-start md:items-center justify-between">
        ...
        <div className="flex items-center gap-2 w-full md:w-auto">
          <Button variant="outline" className="h-11 px-4 text-xs font-bold border-2 hover:bg-muted/50 flex-1 md:flex-none">
            <Download className="h-3.5 w-3.5 mr-2" />
            Exportar Lista
          </Button>
          <Button className="h-11 px-6 text-xs font-bold shadow-lg shadow-primary/20 flex-1 md:flex-none">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-4 text-xs font-bold">
                  <div className="flex items-center gap-1.5 text-green-600">
                    <CheckCircle2 className="h-4 w-4" /> 38 Presentes
                  </div>
                  <div className="flex items-center gap-1.5 text-red-600">
                    <XCircle className="h-4 w-4" /> 4 Ausentes
                  </div>
                </div>
              </div>
            </CardHeader>
                    ...
                    <TableRow key={student.id} className="hover:bg-muted/10 transition-colors">
                      ...
                      <TableCell className="px-6">
                        <div className="flex items-center justify-center gap-1">
                          <Button variant="ghost" size="icon" className="h-9 w-9 rounded-lg hover:bg-green-50 hover:text-green-600 focus:bg-green-600 focus:text-white transition-all border border-transparent hover:border-green-200">
                            <CheckCircle2 className="h-4 w-4" />
                          </Button>
                          <Button variant="ghost" size="icon" className="h-9 w-9 rounded-lg hover:bg-red-50 hover:text-red-600 focus:bg-red-600 focus:text-white transition-all border border-transparent hover:border-red-200">
                            <XCircle className="h-4 w-4" />
                          </Button>
                          <Button variant="ghost" size="icon" className="h-9 w-9 rounded-lg hover:bg-amber-50 hover:text-amber-600 focus:bg-amber-600 focus:text-white transition-all border border-transparent hover:border-amber-200">
          ...
          <Card className="border-none shadow-sm">
            ...
            <CardContent className="space-y-4">
              <div className="p-3 rounded-xl bg-red-50 border border-red-100 space-y-2">
                <div className="flex items-center justify-between">
                  <span className="text-xs font-bold text-red-700">Carlos Ruiz</span>
                ...
                <Button variant="outline" className="w-full h-7 text-[9px] font-bold border-red-200 text-red-700 bg-white hover:bg-red-50">Notificar Estudiante</Button>
              </div>

              <div className="p-3 rounded-xl bg-amber-50 border border-amber-100 space-y-2">
                <div className="flex items-center justify-between">
                  <span className="text-xs font-bold text-amber-700">Juan Pérez</span>
                ...
                <Button variant="outline" className="w-full h-7 text-[9px] font-bold border-amber-200 text-amber-700 bg-white hover:bg-amber-50">Enviar Recordatorio</Button>
              </div>
            </CardContent>
          </Card>
